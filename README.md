...
**http://43.204.24.84:8000/**

### Interactive Documentation
- **Swagger UI:** http://43.204.24.84:8000/docs
- **ReDoc:** http://43.204.24.84:8000/redoc

### Quick Test

**Health Check:**
```bash
curl http://43.204.24.84:8000/health
```

**Prediction Example:**
```bash
curl -X POST http://43.204.24.84:8000/predict \
